...
<fmt:message bundle="${loc}" key="locale.message.ChooseFile" var="ChooseFile"/>
<fmt:message bundle="${loc}" key="locale.message.Download" var="Download"/>
<fmt:message bundle="${loc}" key="locale.message.File" var="File"/>
<fmt:message bundle="${loc}" key="locale.message.WrongFormat" var="WrongFormat"/>
...
<script type="text/javascript">
    ...
    function check(){
        f_file=document.inputform.file.value.toString();
        if (f_file==''){
            alert('${File}');
            return false;
        }
        if (f_file.indexOf('.csv')==-1){
            alert('${WrongFormat}');
            return false;
        }
        return true;
...
<c:set scope="session" value="/WEB-INF/jsp/import.jsp" var="current-page"/>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-offset-3 col-lg-6">
            <div class="panel panel-primary">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 col-lg-offset-8" >
                                <div class="btn-group">
                                    ...
                                    document.getElementById('form').enctype='application/x-www-form-urlencoded';" form="form">
                ...
                <div align="center" style="color: red"><c:out value="${file_info}"/></div>
                <form role="form" action="controller" method="post" name="inputform" id="form"
                      onsubmit="if(document.getElementById('command').value=='download')return check();">
                        ...
                        <div class="row" align="center">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-lg-offset-3">
                                <div class="btn-group">
                                    ...
                                    <button  type="submit" form="form" class="btn btn-labeled btn-primary"
                                             onclick="document.getElementById('command').value='download';
                                             document.getElementById('form').enctype='multipart/form-data';">
                                                  <span class="btn-label" ><i class="glyphicon glyphicon-download-alt"></i>
                                                  </span> ${Download}
                                    </button>
                                </div>
                            </div>
