...
public class Controller extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException, ControllerException {
        ...
        if(page!=null){
            ...
            try{
                commandName = CommandName.valueOf(request.getParameter(RequestParameterName.COMMAND_NAME).toUpperCase().replace("-","_"));
            }catch (NullPointerException e){
                commandName = CommandName.DOWNLOAD;
            }*/
           /*
            if(commandName.equals(CommandName.GO_TO_MAIN_PAGE)){
